...
const Contact: React.FC = () => {
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      +91 9947250346, +91 9946089750<br />
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="text-center mb-8">
      ...
      <p className="text-gray-600 dark:text-gray-300">Visit our office</p>
    </div>
    
    {/* Map Section */}
   <div className="bg-gray-300 dark:bg-gray-600 rounded-lg overflow-hidden">
  <iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3151.835234543529!2d-122.41941568464837!3d37.77492927975923!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80859a6d00690021%3A0x4a501367f076adff!2sGoogleplex!5e0!3m2!1sen!2sus!4v1623456789!5m2!1sen!2sus" // Replace with your embed URL
    width="100%"
