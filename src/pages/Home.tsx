...
import { ArrowRight, Star, Users, MapPin, Calendar, MessageCircle } from 'lucide-react';
  ...
  return (
    <div className="fixed bottom-8 right-8 z-50">
      <button
        ...
        className="bg-sky-500 text-white p-4 rounded-full shadow-lg hover:bg-sky-600 transition-colors duration-200"
        aria-label={isOpen ? 'Close chatbot' : 'Open chatbot'}
      >
        <MessageCircle className="h-6 w-6" />
      </button>
      {isOpen && (
        <div className="absolute bottom-16 right-0 w-80 md:w-96 h-[500px] bg-white dark:bg-gray-800 rounded-lg shadow-xl overflow-hidden">
          <iframe
            src="https://chatthing.ai/bots/8e51f44b-b1ed-4f95-87ad-b4612cfca23e/embed"
            width="100%"
            height="100%"
            frameBorder="0"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              With over 5 years of experience, we've helped thousands of travelers create unforgettable memories
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">5+ Years Experience</h3>
