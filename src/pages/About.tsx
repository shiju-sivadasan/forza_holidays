...
const About: React.FC = () => {
  ...
  {
    name: 'Zed one',
    role: 'Edition Name : Karimlala',
    image: 'static/images/froza_zedone.jpeg',
    description: 'Spacious and comfortable 49-seater Zedone tourist bus, ideal for group tours and events across Kerala and South India—ensuring safe, smooth, and memorable travel experiences.'
  },
  {
    name: 'Capella',
    role: 'Edition Name : Japan',
    image: 'static/images/froza_cappela.jpeg',
    description: 'Specialist in organizing personalized devotional and family tours across Kerala with our spacious and comfortable 49-seater Cappela coach—perfect for group travel with safety and convenience.'
  },
  {
    name: 'Zed Astra',
    role: 'Edition Name : Loading',
    image: 'static/images/forza_chase.png',
    description: 'Experience the ultimate in luxury travel with the Zed Astra—designed to turn every journey into an unforgettable adventure'
  }
];
  ...
  const timeline = [
    { year: '2020', event: 'Forza Holidays founded with a vision to inspire travel.' },
    { year: '2020', event: 'Introduced devotional and family trip packages.' },
    { year: '2022', event: 'Expanded to international destinations.' },
    { year: '2023', event: 'Launched college and industrial visit programs.' },
  ...
  return (
    <div className="py-16 dark:bg-gray-900">
      {/* Hero Section */}
      <section className="relative py-24 bg-gradient-to-r from-sky-600 to-indigo-400 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-6xl font-extrabold mb-6 animate-fade-in-up tracking-tight">Discover The World</h1>
          <p className="text-xl md:text-2xl max-w-3xl mx-auto animate-fade-in-up animation-delay-200 leading-relaxed">
  With over 5 years of experience, forza holidays has been your trusted partner in crafting unforgettable travel experiences—whether it’s a soulful devotional journey, a joyful family adventure, a romantic honeymoon, or an exciting abroad exploration.
          </p>
          <a
            href="/packages"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300">
             The BackBone of Forza Holidays
            </p>
          </div>
      ...
      {/* Call to Action */}
      <section className="py-20 bg-red-600 to-sky-500 text-white">
