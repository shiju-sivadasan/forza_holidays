  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="static/images/background_image.jpeg" // Ensure correct path (use forward slashes)
      ...
      <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight animate-fade-in-up">
          Discover Your Next
          <span className="block text-red-600">Adventure</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up animation-delay-400">
          <button
            ...
            className="inline-flex items-center px-8 py-4 bg-red-500 text-white font-semibold text-lg rounded-lg hover:bg-sky-600 transition-all duration-300 transform hover:scale-105 shadow-lg"
          >
            Explore Packages
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 pt-8 border-t border-white border-opacity-20 animate-fade-in-up animation-delay-600">
          ...
          <div>
            <div className="text-3xl md:text-4xl font-bold text-sky-400">5+</div>
